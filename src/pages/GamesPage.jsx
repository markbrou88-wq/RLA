...
export default function GamesPage() {
  ...
  async function handleDelete(gameId) {
    if (
      !window.confirm(
        t("Delete this game? This cannot be undone.") ||
  ...
  // Inline link-style button to match “Live / Boxscore” look
